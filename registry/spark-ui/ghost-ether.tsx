"use client";
/* eslint-disable @typescript-eslint/no-explicit-any -- three.js/WebGL uniform interop */
...
export default function GhostEther({
  ...
  const webglRef = useRef<GhostEtherWebGL | null>(null);
...
`;
    ...
    class WebGLManager implements GhostEtherWebGL {
      props: any;
      output!: Output;
