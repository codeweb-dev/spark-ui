...
export const BLOG_POSTS: readonly BlogPost[] = [
  {
    ...
    paragraphs: [
      "Today's release rolls a full day of updates into one: version 2.3.0 introduces the Keyboard component and a typing test on the homepage, adds Hello — an Apple-style welcome greeting — to Text & Motion, rebuilds Masonry into an animated grid that now powers two pages, and draws a clean boundary between the open-source frontend and the private production backend, with a flag that makes contributing a zero-setup experience.",
